...
export default function LearnHistoryLayoutTwo() {
    return(
        <SafeAreaView className="flex-1 bg-white">
            <VStack className="flex-1 max-w-full min-h-full m-4 justify-between">
                ...
                <Button 
                    ...
                    onPress={() => router.push('/(home)/learn/lesson/history/lesson3')}
                    >
