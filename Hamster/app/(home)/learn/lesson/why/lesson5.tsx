...
export default function WhyLesson5() {
    return(
            ...
            <VStack className="flex-1 max-w-full min-h-full m-4 justify-between">
                <VStack>
                    ...
                    <VStack space="4xl" className="items-center justify-center">
                        <Image
                        source={require('@/assets/images/learn/lesson/saveles5.png')}
                        className="h-40 w-50 mt-20"
                        alt="lesson"
                        resizeMode="contain"
                        />
                        <Text className="text-lg font-mali_semibold text-getStarted mt-14 text-center">
                            Little money saved often can become enough for a big wish. Always save a little from what you get.
                        </Text>
                    </VStack>
                </VStack>
                ...
                <Button 
                    ...
                    onPress={() => router.replace('/(home)/learn/lesson/learncompletion')}
                    >
