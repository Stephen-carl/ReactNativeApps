...
export default function WhyLesson4() {
    return (
            ...
            <VStack className="flex-1 max-w-full min-h-full m-4 justify-between">
                <VStack>
                    ...
                    <VStack space="4xl" className="items-center justify-center">
                        <Image
                        source={require('@/assets/images/learn//lesson/les4.png')}
                        className="h-40 w-50 mt-20"
                        alt="lesson"
                        resizeMode="cover"
                        />
                        <Text className="text-lg font-mali_semibold text-getStarted mt-14 text-center">
                            Saving also helps if an accident or surprise happens.
                        </Text>
                    </VStack>
                </VStack>
                ...
                <Button 
                    ...
                    onPress={() => router.push('/(home)/learn/lesson/why/lesson5')}
                    >
