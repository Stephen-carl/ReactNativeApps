...
export default function NeedsLesson4() {
    return(
            ...
            <VStack className="flex-1 max-w-full min-h-full m-4 justify-between">
                <VStack>
                    ...
                    <VStack space="4xl" className="items-center justify-center">
                        <Image
                        source={require('@/assets/images/learn/lesson/needtoy.png')}
                        className="h-36 w-36 mt-20"
                        alt="lesson"
                        resizeMode="cover"
                        />
                        <Text className="text-lg font-mali_semibold text-getStarted mt-14">
                            Toys, video games, and candy are wants.
                        </Text>
                    </VStack>
                </VStack>
                ...
                <Button 
                    ...
                    onPress={() => router.push('/(home)/learn/lesson/needwant/lesson5')}
                    >
