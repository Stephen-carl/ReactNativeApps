...
export default function QuizWhy3() {
    ...
    const handleSubmit = () => {
        if (text !== correctAnswer){
            ...
            showSuccessAlert(
                "That's right!! 🥳🎉",`You have to save money to use for emergencies.`
            )
        ...
        <SafeAreaView className="flex-1 bg-white">
            <VStack className="flex-1 max-w-full min-h-full m-4 justify-between">
                ...
                <Text className="text-2xl text-getStarted font-mali_semibold my-11">
                    Saving money can help if something breaks or there is an emergency.
                </Text>
